...
#SHEETS_key = 'RLoJsN4GIsV84Rmq6Y7fJ1'
  ...
  while (key_detect==0) :
    ...
    if (times==1):
      ...
      for num in range(len(results)) :
        ...
        # if (labels[label_id] and (box_left > 320) == 'person'):
        if (labels[label_id] != ''):    #框選特定類別
          print("跟我一起讀: ",labels[label_id])
          time.sleep(2)
          speak(labels[label_id],"en")  #語音輸出英文
          ...
          r = requests.post(LINE_URL, params={"value1":"123","value2": "辨識出是" + labels[label_id],"value3":"https://www.google.com/search?q=" + labels[label_id]})
